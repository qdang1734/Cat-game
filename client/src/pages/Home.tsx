          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="absolute right-8 top-1/3 z-10 flex flex-col items-center">
                <div className="flex items-center bg-black/50 backdrop-blur-sm rounded-lg p-1.5">
                  <UserIcon className="text-lg" />
                </div>
                <span className="text-xs mt-1 bg-black/50 backdrop-blur-sm px-2 py-0.5 rounded">{eggs[currentEgg].name}</span>
              </div>
            </>
          )}
